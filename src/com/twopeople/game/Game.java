...
public class Game extends Canvas implements Runnable {
    ...
    public static int HEIGHT = 560;//480
    ...
    public static void main(String[] args) {
        {
            File soundFile3 = new File("res/audio/loop2min.wav"); //Звуковой файл
            //Получаем AudioInputStream
            //Вот тут могут полететь IOException и UnsupportedAudioFileException
            AudioInputStream ais1 = null;
            try {
                ais1 = AudioSystem.getAudioInputStream(soundFile3);
            ...
            clip1.setFramePosition(0); //устанавливаем указатель на старт
            clip1.start(); //Поехали!!!}
